define('internationalAddress-cmpt/manifest',{
    component: {
        spec: 'blue-spec-shared/address'
    },
    views: {
        internationalAddressView: './views/international'
    }
});
define('internationalAddress-cmpt/validator',['require','form-blocks-common/validationUtil'],function(require) {
    'use strict';

    var util = require('form-blocks-common/validationUtil'),
        // International address field Regex
        addressRegex = {
            addressLine1: /^[a-zA-Z0-9,:/$&#'\-. ]{0,30}$/,
            addressLine2: /^[a-zA-Z0-9,:/$&#'\-. ]{0,30}$/,
            provinceId: /^[a-zA-Z0-9.,:/$&#'\- ]{1,20}$/,
        ...
        // custom validators for international address
        formValidators = {
            addressLine1: validateProperty,
            addressLine2: validateOptionalProperty,
            provinceId: validateProperty,
            postalCode: validateProperty,
            cityId: validateProperty,
            countryId: util.validateSelection
        };

    return formValidators;
});
define('internationalAddress-cmpt/component',['require','appkit-utilities/validation/componentValidate','internationalAddress-cmpt/validator'],function(require) {
    'use strict';

    return function internationalAddressComponent(componentContext) {
        ...
        me.init = function() {
            ...
            var internationalAddressValidator = require(
                'internationalAddress-cmpt/validator');
            var _model = me.model.get();

            validation.call(me, componentContext, internationalAddressValidator);
...
// jscpd:ignore-start
define ('internationalAddress-cmpt/views/spec/address',{
    'name': 'ADDRESS',
    'bindings': {
        'addressId': {
            'direction': 'BOTH'
...
// jscpd:ignore-end;
define('internationalAddress-cmpt/template/international',[], function() { return {"v":4,"t":[{"t":7,"e":"div","m":[{"n":"class","f":"jpmcbb internationalAddressForm","t":13}],"f":[{"t":4,"f":[" ",{"t":8,"r":"addressLine"}," ",{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldRow","t":13}],"f":[{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldCell","t":13}],"f":[{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-city-fldgrp"],"t":13},{"n":"analyticsId","f":"cityId","t":13},{"n":"groupType","f":"validationInput vertical","t":13},{"n":"label","f":[{"t":2,"r":".cityNamesLabel"}],"t":13},{"n":"inputValue","f":[{"t":2,"r":".cityId"}],"t":13},{"n":"validationInput","f":["{ 'name':'cityId', 'placeholder': '', 'addValidation':'true', 'errorMessage':",{"t":2,"rx":{"r":".v","m":[{"r":[],"s":"\"cityId\""},"errorMessage"]}},", 'errorMessageForce':",{"t":2,"rx":{"r":".v","m":[{"r":[],"s":"\"cityId\""},"errorMessage"]}},", 'rBlur': 'validateField', 'rFocus': 'formFieldTracking', 'rChange': 'formFieldTracking', 'maxLength':'30', 'required': true, 'labelErrorPrefix': '",{"t":2,"r":".errorAnnouncementAda","s":true},"', 'autocomplete': 'new-password' }"],"t":13}]}]}," ",{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldCell","t":13}],"f":[{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-state-prov-fldgrp"],"t":13},{"n":"analyticsId","f":"provinceId","t":13},{"n":"groupType","f":"validationInput vertical","t":13},{"n":"label","f":[{"t":2,"r":".stateOrProvinceLabel","s":true}],"t":13},{"n":"inputValue","f":[{"t":2,"r":".provinceId"}],"t":13},{"n":"validationInput","f":["{ 'name':'provinceId', 'placeholder': '', 'addValidation':'true', 'errorMessage':",{"t":2,"rx":{"r":".v","m":[{"r":[],"s":"\"provinceId\""},"errorMessage"]}},", 'errorMessageForce':",{"t":2,"rx":{"r":".v","m":[{"r":[],"s":"\"provinceId\""},"errorMessage"]}},", 'rBlur': 'validateField', 'rFocus': 'formFieldTracking', 'rChange': 'formFieldTracking', 'maxLength':'20', 'required': true, 'labelErrorPrefix': '",{"t":2,"r":".errorAnnouncementAda","s":true},"', 'autocomplete': 'new-password' }"],"t":13}]}]}]}," ",{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldRow","t":13}],"f":[{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldCell","t":13}],"f":[{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-postalcd-fldgrp"],"t":13},{"n":"analyticsId","f":"postalCode","t":13},{"n":"groupType","f":"validationInput vertical","t":13},{"n":"label","f":[{"t":2,"r":".postalCodeLabel","s":true}],"t":13},{"n":"inputValue","f":[{"t":2,"r":".postalCode"}],"t":13},{"n":"validationInput","f":["{ 'name':'postalCode', 'placeholder':'', 'addValidation':'true', 'errorMessage': ",{"t":2,"rx":{"r":".v","m":[{"r":[],"s":"\"postalCode\""},"errorMessage"]}},", 'errorMessageForce': ",{"t":2,"rx":{"r":".v","m":[{"r":[],"s":"\"postalCode\""},"errorMessage"]}},", 'rBlur': 'validateField', 'rFocus': 'formFieldTracking', 'rChange': 'formFieldTracking', 'maxLength':'20', 'type': 'tel', 'required': true, 'labelErrorPrefix': '",{"t":2,"r":".errorAnnouncementAda","s":true},"', 'autocomplete': 'new-password' }"],"t":13}]}]}," ",{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldCell","t":13}],"f":[{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-country-fldgrp"],"t":13},{"n":"analyticsId","f":"countryId","t":13},{"n":"groupType","f":"vertical validationStyledSelect","t":13},{"n":"label","f":[{"t":2,"r":"countriesLabel","s":true}],"t":13},{"n":"styledSelectValue","f":[{"t":2,"r":"countryId"}],"t":13},{"n":"validationStyledSelect","f":["{ 'name': 'countryId', 'value': ",{"t":2,"r":"countryId"},", 'options': ",{"t":2,"r":"countries"},", 'placeholder': ",{"t":2,"r":"countryNamePlaceholder","s":true},", 'errorMessage': ",{"t":2,"rx":{"r":".v","m":[{"r":[],"s":"\"countryId\""},"errorMessage"]}},", 'aria': { selected: '",{"t":2,"r":".currentSelectionAda","s":true},"', bottomOfMenu: '",{"t":2,"r":".endOfSelectionAda","s":true},"', buttonLabel: '",{"t":2,"r":".countriesLabel","s":true}," ",{"t":2,"r":".requiredAda","s":true},"', describedByButton: 'countryId' }, 'rChange': ['formFieldTracking', 'validateCountry'], 'rBlur': ['formFieldTracking','validateCountry'], 'classicResponsive': true, 'isRequired': true, 'hatErrorPrefix': '",{"t":2,"r":".errorAnnouncementAda","s":true},"', 'autocomplete': 'new-password' }"],"t":13}]}]}]}],"n":50,"x":{"r":[".customerInformationAvailable",".editMode"],"s":"!_0||_1"}},{"t":4,"n":51,"f":[{"t":8,"r":"addrExistingUser"}],"l":1}]}],"e":{}}; });
define('internationalAddress-cmpt/template/_addrLine',[], function() { return {"v":4,"t":[{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldRow","t":13}],"f":[{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldCell","t":13}],"f":[{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-addrl1-fldgrp"],"t":13},{"n":"analyticsId","f":"addressLine1","t":13},{"n":"groupType","f":"validationInput vertical","t":13},{"n":"label","f":[{"t":2,"r":"addressLine1Label","s":true}],"t":13},{"n":"inputValue","f":[{"t":2,"r":"addressLine1"}],"t":13},{"n":"validationInput","f":["{ 'name':'addressLine1', 'placeholder': '', 'addValidation':'true', 'errorMessage':",{"t":2,"rx":{"r":"v","m":[{"r":[],"s":"\"addressLine1\""},"errorMessage"]}},", 'errorMessageForce':",{"t":2,"rx":{"r":"v","m":[{"r":[],"s":"\"addressLine1\""},"errorMessage"]}},", 'rBlur': 'validateField', 'rFocus': 'formFieldTracking', 'rChange': 'formFieldTracking', 'maxLength':'30', 'required': true, 'labelErrorPrefix': '",{"t":2,"r":"errorAnnouncementAda","s":true},"', 'autocomplete': 'new-password' }"],"t":13}]}]}," ",{"t":7,"e":"div","m":[{"n":"class","f":"inlineFieldCell","t":13}],"f":[{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-addrl2-fldgrp"],"t":13},{"n":"analyticsId","f":"addressLine2","t":13},{"n":"groupType","f":"validationInput vertical","t":13},{"n":"label","f":[{"t":2,"r":"addressLine2Label","s":true}],"t":13},{"n":"additionalText","f":[{"t":2,"r":".optionalLabel","s":true}],"t":13},{"n":"inputValue","f":[{"t":2,"r":"addressLine2"}],"t":13},{"n":"validationInput","f":["{ 'name':'addressLine2', 'placeholder':'', 'addValidation':'true', 'errorMessage':",{"t":2,"rx":{"r":"v","m":[{"r":[],"s":"\"addressLine2\""},"errorMessage"]}},", 'errorMessageForce':",{"t":2,"rx":{"r":"v","m":[{"r":[],"s":"\"addressLine2\""},"errorMessage"]}},", 'rBlur': 'validateField', 'rFocus': 'formFieldTracking', 'rChange': 'formFieldTracking', 'maxLength':'30', 'labelErrorPrefix': '",{"t":2,"r":"errorAnnouncementAda","s":true},"', 'autocomplete': 'new-password' }"],"t":13}]}]}]}],"e":{}}; });
define('internationalAddress-cmpt/template/_addrExistingUser',[], function() { return {"v":4,"t":[{"t":7,"e":"div","f":[{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-addr-street-fldgrp"],"t":13},{"n":"groupType","f":"fieldtext horizontal","t":13},{"n":"labelColumns","f":"col-xs-4 col-sm-6","t":13},{"n":"inputColumns","f":"col-xs-8 col-sm-6","t":13},{"n":"label","f":[{"t":2,"r":".addressLabel","s":true}],"t":13},{"n":"fieldTextValue","f":[{"t":2,"r":".addressLine1"},", ",{"t":2,"r":".addressLine2"}],"t":13}]}," ",{"t":7,"e":"blueFieldGroup","m":[{"n":"id","f":[{"t":2,"r":"blockId","s":true},"-addr-region-fldgrp"],"t":13},{"n":"groupType","f":"fieldtext horizontal","t":13},{"n":"labelColumns","f":"col-xs-4 col-sm-6","t":13},{"n":"inputColumns","f":"col-xs-8 col-sm-6","t":13},{"n":"label","f":" ","t":13},{"n":"fieldTextValue","f":[{"t":2,"r":".cityId"},", ",{"t":2,"r":".stateId"}," ",{"t":2,"r":".zipCode"}],"t":13}]}]}]}; });
define('internationalAddress-cmpt/views/international',['require','internationalAddress-cmpt/views/spec/address','appkit-utilities/validation/trigger','internationalAddress-cmpt/template/international','internationalAddress-cmpt/template/_addrLine','internationalAddress-cmpt/template/_addrExistingUser','blue-ui/view/collections/fieldgroup','blue-ui/view/modules/styledselect','blue-ui/view/elements/checkbox'],function(require) {
    'use strict';

    return function internationalAddressView(viewContext) {
        var me = this;
        var extend = viewContext.util.object.extend,
            webSpec = require('internationalAddress-cmpt/views/spec/address'),
        ...
        // extend webspec with validation triggers
        viewContext.page.triggers = triggers;
        extend(webSpec.triggers, viewContext.page.triggers);

        me.bridge = webSpec;

        me.template = require('internationalAddress-cmpt/template/international');
        // partial for address line row
        me.partials = {
            'addressLine': require('internationalAddress-cmpt/template/_addrLine'),
            'addrExistingUser': require('internationalAddress-cmpt/template/_addrExistingUser')
        };
        ...
        /**
         * view action to check country field is selected
         */
        me.validateCountry = function(event){
            me.model.countryId = event.context.value || '';
            // Calls Component validate action to validate country selection
