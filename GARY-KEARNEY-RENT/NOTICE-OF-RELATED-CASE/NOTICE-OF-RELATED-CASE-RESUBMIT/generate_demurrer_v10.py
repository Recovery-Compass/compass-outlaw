...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_PERFECTION.pdf"
...
def create_demurrer_v10():
    ...
    # --- Top Execution Block (Snapped 1-4) ---
    c.setFont("Times-Roman", 12)
    ...
    # Line 14: Header II (No Gap allowed for Snap)
    c.setFont("Times-Bold", 12)
    ...
    # --- Bottom Execution Block (Snapped 25-28) ---
    c.setFont("Times-Roman", 12)
    c.drawString(MARGIN_LEFT, get_y(25), "DATED: February 3, 2026")
    c.drawString(MARGIN_LEFT, get_y(26), "_" * 35)
    c.setFont("Times-Bold", 12)
    ...
    c.save()
    print(f"Final Perfection PDF generated at: {FULL_OUTPUT_PATH}")
