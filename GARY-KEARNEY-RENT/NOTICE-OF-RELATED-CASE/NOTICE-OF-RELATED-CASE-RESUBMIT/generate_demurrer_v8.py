...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_MASTER.pdf"
...
MARGIN_BOTTOM = 0.5 * inch # RESTORED STANDARD FOOTER (v8)
...
def create_demurrer_v8():
    ...
    # New Bottom Date: Line 26
    c.drawString(MARGIN_LEFT, get_y(26), "DATED: February 3, 2026")
    
    # New Bottom Signature: Line 27
    sig_y_bottom = get_y(27)
    ...
    # Line 28 is now empty.
    
    c.save()
    print(f"Final Master PDF generated at: {FULL_OUTPUT_PATH}")
