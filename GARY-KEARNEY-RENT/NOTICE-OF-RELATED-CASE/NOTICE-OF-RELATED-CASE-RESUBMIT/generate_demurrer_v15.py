...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_MODERN.pdf"
...
def create_demurrer_v15():
    ...
    # Caption Box (Lines 11-20) - v15 MODERNIZED
    sep_x = 4.5 * inch
    # REMOVED: Loop of ')' characters
    # ADDED: Single Solid Vertical Line
    c.saveState()
    c.setLineWidth(0.5)
    # Start approx top of Line 11 (get_y(10.8)) to End approx Line 20 (get_y(20.5))
    c.line(sep_x, get_y(10.8), sep_x, get_y(20.5))
    c.restoreState()
    ...
    # --- CAPTION SEAL (v15 FIXED GEOMETRY) ---
    ...
    # FIX v15: Start at 1.35 * inch instead of 1.3 * inch
    left_rail_inner_x = 1.35 * inch 
    right_rail_x = PAGE_WIDTH - 0.5 * inch
    
    c.saveState()
    c.setLineWidth(0.5)
    c.line(left_rail_inner_x, seal_y, right_rail_x, seal_y)
    c.restoreState()
    ...
    # ================= PAGE 3 - EMERALD+STRUCTURE+MODERN EDITION =================
    ...
    c.save()
    print(f"Final Modern Standard PDF generated at: {FULL_OUTPUT_PATH}")
