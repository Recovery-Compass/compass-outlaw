...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_DIAMOND_GRID.pdf"
...
def create_demurrer_v18():
    ...
    # --- CAPTION BOX STRUCTURE (v18 DIAMOND GRID) ---
    c.saveState()
    c.setLineWidth(0.5)
    ...
    # v18 CHANGE: Tighten Seal to just below Line 20.
    # Was get_y(22) + 12.
    # New: Midway between 20 and 21. 
    # Line 20 baseline is Y20. Line 21 is Y21 (Y20 - 24).
    # Box should end after Line 20 text. 
    # Usually separators are 1/2 line height.
    # Let's target get_y(21) + 12. This is half a line ABOVE Line 21 baseline.
    seal_y = get_y(21) + 12 
    
    sep_x = 4.5 * inch
    
    # Rail Snap (v17 fix maintained)
    # 2 points = 2/72 inch.
    ...
    # 2. Bottom Horizontal Line (The Floor - Tightened)
    ...
    # v17 ALIGN CAPTION FIELDS maintained
    c.setFont("Times-Roman", 12)
    ...
    # v18 DIAMOND GRID SNAP: EXACT BASELINES
    ...
    c.save()
    print(f"Final Diamond Grid PDF generated at: {FULL_OUTPUT_PATH}")
