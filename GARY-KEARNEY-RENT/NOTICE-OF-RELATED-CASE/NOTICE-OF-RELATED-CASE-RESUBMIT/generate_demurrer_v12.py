...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_DIAMOND.pdf"
...
def create_demurrer_v12():
    ...
    # Lines 8-11: Intro Body (Compressed, 4 lines)
    # Corrected text from v11 to remove duplication
    c.setFont("Times-Roman", 12)
    ...
    # Line 27: Name
    c.setFont("Times-Bold", 12)
    c.drawString(MARGIN_LEFT, sig_y - 12, "NUHA SAYEGH") 
    
    # Line 28: Title
    c.setFont("Times-Roman", 12)
    c.drawString(MARGIN_LEFT, sig_y - 24, "Defendant in Pro Per") 
    
    c.save()
    print(f"Final Diamond PDF generated at: {FULL_OUTPUT_PATH}")
