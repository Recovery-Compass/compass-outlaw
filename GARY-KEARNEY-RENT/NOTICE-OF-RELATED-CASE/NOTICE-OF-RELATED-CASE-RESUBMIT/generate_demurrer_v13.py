...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_EMERALD.pdf"
...
def create_demurrer_v13():
    ...
    # If text lines are 8, 9, 10, 11 -> `cursor_line` should be 12.
    
    # Ensure next spacer is blank.
    # We want a blank line before "II. THE LEASE..."
    # If intro ends on 11, line 12 is blank.
    # Next header starts at cursor_line + 1 if cursor_line is the blank one?
    # No, `cursor_line` is the Next Available Line. 
    # So if `cursor_line` is 12, we leave 12 blank. 
    ...
    # Lines 14-18 (approx): Body II (5 lines hardcoded previously, let's keep strict)
    # v11 positions: Header 13, Body 14-18. 
    # If header_ii_line matches 13, we are good.
    ...
    # e.g. Start 14. Lines: 14, 15, 16, 17, 18. End 18.
    # Blank 19 (Start + 5). 
    # Header III at 20 (Start + 6).
    ...
    # Line 24: Blank (Implicit if Body III ends at 23)
    ...
    c.save()
    print(f"Final Emerald PDF generated at: {FULL_OUTPUT_PATH}")
