...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_FILING_EQUILIBRIUM.pdf"
...
def create_demurrer_v27():
    ...
    # Caption Box - v23 TIGHTENED LOCK
    c.saveState()
    c.setLineWidth(0.5)
    TOP_SEAL_Y = get_y(11) + 12
    BOTTOM_SEAL_Y = get_y(20) - 10  # v24: Descender-safe clearance
    SEP_X = 4.5 * inch
    ...
    # v26 AESTHETIC LOCK: Optimized Manual Rich Text for Intro
    c.setFont("Times-Roman", 12)
    ...
    draw_manual_rich_line(c, MARGIN_LEFT, 9, [
        ...
        (" (Case No. 26NNCV00412) on", "Times-Roman")
    ])
    c.setFont("Times-Roman", 12)
    c.drawString(MARGIN_LEFT, get_y(10), "January 21, 2026, alleging Fraud and seeking Rescission. Because the First Action")
    c.drawString(MARGIN_LEFT, get_y(11), "challenges the lease's validity and was filed first, this Court must sustain the demurrer.")
    cursor_line = 12
    ...
    c.save()
    print(f"Final Filing Equilibrium PDF generated at: {FULL_OUTPUT_PATH}")
