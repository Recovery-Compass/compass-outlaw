...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_PERFECTED.pdf"
...
MARGIN_TOP = 0.9 * inch  # Retained
MARGIN_BOTTOM = 0.35 * inch # Retained
...
def create_demurrer_v7():
    ...
    # Top of Page 3: Execution Block (Demurrer)
    c.setFont("Times-Roman", 12)
    ...
    # Bottom Signature Block - FIX HERE
    sig_y_bottom = get_y(28)
    c.drawString(MARGIN_LEFT, sig_y_bottom, "_" * 35) # Ensure this is drawn
    ...
    c.save()
    print(f"Final Perfected PDF generated at: {FULL_OUTPUT_PATH}")
