...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_SAFE_HARBOR.pdf"
...
def create_demurrer_v28():
    ...
    # v28 SAFE HARBOR: 5-LINE INTRO (Lines 8-12)
    c.setFont("Times-Roman", 12)
    ...
    c.drawString(MARGIN_LEFT, get_y(11), "Rescission. Because the First Action challenges the lease's validity and was")
    c.drawString(MARGIN_LEFT, get_y(12), "filed first, this Court must sustain the demurrer.")
    ...
    c.save()
    print(f"Final Safe Harbor PDF generated at: {FULL_OUTPUT_PATH}")
