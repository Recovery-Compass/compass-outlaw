...
MARGIN_RIGHT = 0.5 * inch  # RETAINED: 0.5 inch margin
...
def draw_grid_background(c, page_idx):
    ...
    # RETAINED: Footer Divider Line (CRC 2.110)
...
def create_demurrer_v33():
    ...
    # FIX: Moved to Line 22 Baseline to prevent collision with Line 23 Text
    CAPTION_BOTTOM_Y = get_y(22) 
    ...
    # Header starts at Line 23 (Safe distance from CAPTION_BOTTOM_Y at Line 22)
    c.setFont("Times-Bold", 12)
    ...
    # RETAINED: Reflow for wider margins
    ...
    # RETAINED: Reflowed Text for Section I
    c.setFont("Times-Roman", 12)
    ...
    c.save()
    print(f"Final Submission PDF generated at: {FULL_OUTPUT_PATH}")
