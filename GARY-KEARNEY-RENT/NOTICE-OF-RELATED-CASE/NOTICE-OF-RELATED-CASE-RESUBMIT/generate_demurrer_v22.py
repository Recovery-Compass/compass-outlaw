...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_FILING_LOCKED.pdf"
...
def create_demurrer_v23():
    ...
    BOTTOM_SEAL_Y = get_y(20) - 6  # v23: Tightened to hug Line 20 content
    SEP_X = 4.5 * inch
    ...
    c.save()
    print(f"Final Filing Locked PDF generated at: {FULL_OUTPUT_PATH}")
