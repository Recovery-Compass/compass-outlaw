...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_SUBMISSION.pdf"
...
def draw_grid_background(c, page_idx):
    ...
    # 3. Footer (Adjusted Up)
    c.setFont("Times-Roman", 10)
    # Move up 10 points from 0.5 inch (36 pts) -> 46 pts
    footer_y = 0.75 * inch 
...
def create_demurrer_v4():
    ...
    sep_x = 4.5 * inch
    c.setFont("Times-Roman", 12) # Standard font for paranthesis?
    # Loop from line 11 to 20
    ...
    c.setFont("Times-Roman", 12)
    c.drawString(info_x, get_y(17), "Date: _________________")  # Fixed from [Leave Blank]
    ...
    # Line 14: Check spacing "Plaintiff on " -> "January..."
    ...
    # Signature Page 3 - CRITICAL FIX
    # Draw line on Line 28
    signature_y = get_y(28)
    c.drawString(MARGIN_LEFT, signature_y, "_" * 35)
    
    # Text Text BELOW Line 28
    # Just hardcode a drop. LINE_HEIGHT is 24. A regular line drop is fine, or tighter.
    # Text needs to exist, even if it goes into margin.
    name_y = signature_y - 14 # Drop 14 points below the line
    title_y = name_y - 14
    ...
    c.save()
    print(f"Final Polish PDF generated at: {FULL_OUTPUT_PATH}")
