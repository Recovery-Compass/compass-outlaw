...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_FILING_PERFECT.pdf"
...
def create_demurrer_v25():
    ...
    # v25 BLUEBOOK: Manual Rich Text for Intro with Italics
    c.setFont("Times-Roman", 12)
    ...
    c.save()
    print(f"Final Filing Perfect PDF generated at: {FULL_OUTPUT_PATH}")
