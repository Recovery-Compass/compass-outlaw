...
# --- Configuration ---
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_DETERMINISTIC.pdf"
...
# DETERMINISTIC GEOMETRY CONSTANTS (HARD-CODED)
...
def create_demurrer_v31():
    ...
    # Caption Box - v31 DETERMINISTIC: HARD-CODED GEOMETRY
    c.saveState()
    c.setLineWidth(0.5)
    
    # EXACT COORDINATES
    CAPTION_TOP_Y = get_y(11) + 10
    CAPTION_BOTTOM_Y = get_y(21.5) # The Deterministic Floor
    ...
    # v31 DETERMINISTIC MANUAL BLOCK (5 LINES)
    c.setFont("Times-Roman", 12)
    ...
    c.save()
    print(f"Final Deterministic PDF generated at: {FULL_OUTPUT_PATH}")
