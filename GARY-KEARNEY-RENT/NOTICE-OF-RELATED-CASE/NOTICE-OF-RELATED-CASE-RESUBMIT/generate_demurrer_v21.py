...
# --- Configuration ---
OUTPUT_FILENAME = "DEMURRER_FINAL_FILING_MASTER.pdf"
...
def create_demurrer_v21():
    ...
    # --- CAPTION BOX STRUCTURE (v21 FILING MASTER) ---
    c.saveState()
    c.setLineWidth(0.5)
    ...
    # v21 FIX: Explicit Line 14-15 Collision Prevention
    # Line 14
    ...
    # Line 16
    c.drawString(MARGIN_LEFT, get_y(16), "(\"The First Action\") challenges the validity of the lease and seeks rescission.") 
    ...
    # v20 Vector Signature Line Retained
    ...
    c.save()
    print(f"Final Filing Master PDF generated at: {FULL_OUTPUT_PATH}")
